...
export default function HomePage() {
  ...
  if (session && session.user) {
    // Optional chaining se role access kar rahe hain
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen space-y-4">
      <h1 className="text-4xl font-bold">Welcome to Edu LLM</h1>
      <p className="text-lg">Please sign in or sign up to access your portal.</p>
