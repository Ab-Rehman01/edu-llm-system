...
//     "bg-black bg-opacity-50 backdrop-blur-md p-8 rounded-lg flex flex-col items-center justify-center";
    ...
    >
      ...
      <div className="relative z-10 p-8 rounded-xl bg-white/20 backdrop-blur-lg flex flex-col items-center space-y-6 text-center">
        {session && session.user ? (
          ...
          <>
            <h1 className="text-4xl font-bold text-white drop-shadow-lg">Welcome to Moosa Online Training Institute</h1>
            <h3 className="text-4xl font-bold text-white drop-shadow-lg">Mr. Faizan (+92300-5446695)</h3>
